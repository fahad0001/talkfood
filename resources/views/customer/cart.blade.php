@extends('customer.layout.master') @section('style')
<style>
...
@endsection @section('content') @include('customer.layout.navigation2')
                    ...
                    <form action="{{URL::to('/updatecart')}}" method="POST">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                {{csrf_field()}}
                                <?php $i = 1; ?> @foreach($cart as $item) @if(!is_array($item)) @else
                                <tr>
                                    <th scope="row"><a href="{{URL::to('/cart/delete')}}/{{$item['key']}}"><i class='fa fa-2x fa-close' style="color:red;"></i></a></th>
                                    <td>{{ $item['food_name'] }} @if($item['submenu_status']==1) @foreach($item['subitem'] as $s)
                                    ...
                                    <td> @if($item['submenu_status']==1)
                                        <?php $totali=$item['food_price'];?>
                                        <?php $sub=0; ?> @foreach($item['subitem'] as $is)
                                        <?php $sub=$sub+$is['price']?> @endforeach {{ $totali+$sub }} @else {{$item['food_price']}} @endif </td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <h4><b>Delivery Fee </b> </h4>
                                        </td>
                                        <td style='    vertical-align: middle;'>${{$shipping}} CAD</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h4><b>Delivery Tax </b> </h4>
                                        </td>
                                        <td style='    vertical-align: middle;'>${{$shippingtax}} CAD</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h4><b>Tax </b> </h4>
                                        </td>
                                        <td style='    vertical-align: middle;'>${{$tax}} CAD</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h4><b>Driver Tip<span id="dtip">(2.5 $CAD)</span></b> </h4>
                                        </td>
                                        <td style='vertical-align: middle;'>$<span id="dtipv">{{$drivertip}}</span> CAD <button id="tipchange" class="btn btn-primary"> Change</button> </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h4><b>Total </b> </h4>
                                        </td>
                                        <td style='    vertical-align: middle;'>$<span id="tt">{{$total}}</span> CAD</td>
                                    </tr>
                                </tbody>
